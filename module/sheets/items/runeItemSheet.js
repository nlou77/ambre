 ...
 * @extends {ItemSheet}
 */
export default class RuneItemSheet extends ItemSheet {

  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["ambre", "sheet", "item", "rune"],
      template: "systems/ambre/templates/sheets/items/runes.hbs",
      width: 520,
      height: 500,
  ...
  /** @override */
  get template() {
    return `systems/ambre/templates/sheets/items/runes.hbs`;
  }
  ...
  activateListeners(html) {
    ...
    // --- Explicitly handle drag and drop on the target elements ---
  ...
  async _onDotClick(event) {
      ...
      while (status.length < exemplaires) {
          status.push(false);
      }
